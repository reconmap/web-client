...
export default function Header() {
  ...
  return <header className="flex items-center justify-between w-full  p-2 ">
    ...
    <nav className="font-semibold gap-5 flex items-center">
      ...
      {authContext.logged ? <button onClick={handleLogOut} className='rounded bg-gray-800 py-2 px-4'>Log out</button>
