...
export const IconExternalLink = ({styling}) => <svg style={styling} className={`external-link `} fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24"
                                                    xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
          d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
</svg>
export const IconDark = ({styling}) => <svg style={styling} className={`dark `} fill="none" stroke="currentColor"
...
export const IconLogin = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
                                             className={`login `}>
    <path fillRule="evenodd"
...
export const IconLogout = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
                                              className={`logout `}>
    <path fillRule="evenodd"
...
export const IconComment = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
...
export const IconRight = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
...
export const IconDelete = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
                                              className={`backspace `}>
    <path fillRule="evenodd"
...
export const IconExperiments = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
                                                   className={`beaker `}>
    <path fillRule="evenodd"
...
export const IconBell = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling} className={`bell `}>
    <path
        d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z"/>
</svg>

export const IconBookmark = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
                                                className={`bookmark `}>
...
export const IconBriefcase = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
                                                 className={`briefcase `}>
    <path fillRule="evenodd"
...
export const IconCheckCircle = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
...
export const IconDatabase = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
                                                className={`database `}>
...
export const IconDots = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
                                            className={`dots-horizontal `}>
    <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z"/>
</svg>

export const IconDuplicate = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
                                                 className={`duplicate `}>
    <path d="M7 9a2 2 0 012-2h6a2 2 0 012 2v6a2 2 0 01-2 2H9a2 2 0 01-2-2V9z"/>
    <path d="M5 3a2 2 0 00-2 2v6a2 2 0 002 2V5h8a2 2 0 00-2-2H5z"/>
</svg>

export const IconDownload = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
                                                className={`download `}>
    <path fillRule="evenodd"
...
export const IconEyeOff = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
                                              className={`eye-off `}>
    <path fillRule="evenodd"
...
export const IconFilter = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
                                              className={`filter `}>
    <path fillRule="evenodd"
...
export const IconFingerPrint = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
...
export const IconFire = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling} className={`fire `}>
    <path fillRule="evenodd"
...
export const IconKey = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling} className={`key `}>
    <path fillRule="evenodd"
          d="M18 8a6 6 0 01-7.743 5.743L10 14l-1 1-1 1H6v2H2v-4l4.257-4.257A6 6 0 1118 8zm-6-4a1 1 0 100 2 2 2 0 012 2 1 1 0 102 0 4 4 0 00-4-4z"
          clipRule="evenodd"/>
</svg>

export const IconLocked = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
...
export const IconUnlocked = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling}
                                                className={`lock-open `}>
    <path
...
export const IconStar = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling} className={`star `}>
    <path
        d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
</svg>

export const IconTag = ({styling}) => <svg viewBox="0 0 20 20" fill="currentColor" style={styling} className={`tag `}>
    <path fillRule="evenodd"
...
export const IconList = ({styling}) => <svg style={styling}  fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"></path></svg>
export const IconChevronDown = ({styling}) => <svg style={styling} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
export const IconChevronUp = ({styling}) => <svg style={styling} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"></path></svg>
